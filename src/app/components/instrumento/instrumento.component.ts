...
import { LineaPlan } from '../../models/linea';
import { Instrumento } from '../../models/instrumento';
import { CompetenciasService }  from '../../services/competencia.service';
...
@Component({
  ...
  providers: [SemestreService,LineaService,CompetenciasService,CicloService,
  {provide: MatFormFieldControl,useExisting:InstrumentoComponent}]
})
